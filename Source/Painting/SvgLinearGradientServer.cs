...
namespace Svg
{
    ...
    public sealed class SvgLinearGradientServer : SvgGradientServer
    {
        ...
        private LinePoints PointsToMove(ISvgBoundable boundable, PointF specifiedStart, PointF specifiedEnd)
        {
            ...
            return (boundable.CalculateBounds().Contains(specifiedStart) ? LinePoints.Start : LinePoints.None) |
                   (boundable.CalculateBounds().Contains(specifiedEnd) ? LinePoints.End : LinePoints.None);
        }
